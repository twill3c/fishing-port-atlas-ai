...
export default function DataPage() {
  ...
  return (
    <main className="article">
      ...
      <section>
        <h2 id="not-listed">この地図に載らない港</h2>
        <p>
          この地図に載せているのは、水産庁の「漁港一覧」にある<strong>指定漁港</strong>
          (漁港漁場整備法にもとづいて指定された港)だけである。
          港湾法の<strong>港湾</strong>として指定された港は、魚市場があって水揚げが多くても、
          この一覧にも国土数値情報の漁港データにも入っていないので、地図には出ない。
        </p>
        <p>
          たとえば<strong>小名浜港</strong>(福島県いわき市)は、水産庁の漁港一覧にも国土数値情報の漁港データにも
          「小名浜」の名が 1 件も無い。福島県のページには「重要港湾指定/昭和26年1月19日」「管理者/福島県」とあり、
          あわせて「四季を通して多くの水産物が水揚げされる水産業の拠点」とも書かれている
          (
          <a href="https://www.pref.fukushima.lg.jp/sec/41400a/onahama-port-onahama.html">
            福島県「重要港湾 小名浜港」
          </a>
          、2026-09-17 確認)。いわき市の指定漁港は小浜・久之浜・四倉・豊間・勿来の 5 港で、
          名前の似た「小浜漁港」は小名浜港とは別の港である。
        </p>
        <p className="hint">
          港湾側のデータ(港湾の位置や区分)はこの地図では読み込んでいない。
          ある港が港湾か漁港かは、国土交通省や港のある自治体の資料で確かめること。
        </p>
      </section>
      ...
      <ul>
        ...
        <li>
          津波浸水想定の区域を全国一括で地図に重ねる表示: 形を崩さずに全国を配るには
          ベクトルタイルの生成が要り、まだ作っていない。港ごとには、その港の周り 500 m の区域の面を
          「防災」タブから地図に重ねられる(再配布してよい都道府県の 2,310 港)
        </li>
      </ul>
